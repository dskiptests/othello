...
public class DeepOthello extends Agent {
    ...
    private int calculateMaxValue(LinkedList<othello.game.Position> availiblePositions){
    ...
    private int calculateBoardValue(LinkedList<othello.game.Position> availablePositions){
